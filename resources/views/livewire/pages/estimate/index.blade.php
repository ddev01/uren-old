        ...
        <div>
            <div class="w-full shadow-primary p-8 rounded-lg bg-white dark:bg-gray-800">
                ...
                <div class="pb-4 flexb mt-8">
                    ...
                    <div class="w-1/3">
                        <x-flowbite.inputs.input wire:model.live.debounce.300ms="searchFilter" clear placeholder="Search" name="searchFilter" prefix="search" prefixFade suffix="search" suffixFade />
                    </div>
                </div>
